<template>
  <section
    :class="['mb-24', mode.value === Mode.Developer ? '' : 'hidden']"
    id="experience"
  >
    <SectionTitle
      :title="mode.value === Mode.Developer ? 'Work Experience' : 'Gaming Milestones'"
    />
    ...
    <div class="relative">
      ...
      <div
        :class="[
          ...
          mode.value === Mode.Developer ? 'bg-gray-200' : 'bg-purple-900',
        ]"
        aria-hidden="true"
      ></div>
        ...
        >
          ...
          <div
            :class="[
              ...
              mode.value === Mode.Developer ? 'bg-gray-900' : 'bg-purple-600',
            ]"
            style="top: 24px"
            aria-hidden="true"
          ></div>
          ...
          >
            <h3
              :class="[
                ...
                mode.value === Mode.Developer ? 'font-serif' : 'font-mono',
              ]"
            >
              {{ item.title }}
            </h3>
...
const { mode } = useMode()
console.log('Experience mode:', mode.value) // Debug mode value
...
const developerExperience: TimelineItem[] = [
  ...
  },
  {
    ...
    location: 'HCM, Vietnam',
    description:
      'I joined the IT Lab as an assistant and worked with other members who share the same passion to improve my skills and gain practical experience in the field through hands-on, real-life projects',
  },
]
...
console.log('timelineItems:', timelineItems.value) // Debug timeline items
</script>
